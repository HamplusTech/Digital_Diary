...
Public Class frmmobility
    ...
    Private Sub btnok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnok.Click
        If frmmyprofile.TextBox1.Text = "Delete" Then
            ...
            Me.Hide()
            frmmyprofile.Close()
            Dim a As Integer = MsgBox("Your mobility Info will be permenantly deleted. Do you wish to continue?", MsgBoxStyle.YesNo, Title:="Blinks Digital Diary")
            If a = MsgBoxResult.Yes Then
                udechukwu.ExecuteNonQuery()
                reinsert.ExecuteNonQuery()
                Dim aa As Integer = MsgBox("Your mobility info has been deleted.", MsgBoxStyle.OkOnly, Title:="Blinks Digital Diary")
                Me.Close()
            Else
                Me.Show()
            End If

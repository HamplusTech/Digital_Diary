...
Public Class frmbio
    ...
    Private Sub btnok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnok.Click
        If frmmyprofile.TextBox1.Text = "Delete" Then
            ...
            Me.Hide()
            frmmyprofile.Close()
            Dim a As Integer = MsgBox("Your biodata will be permenantly deleted. Do you wish to continue?", MsgBoxStyle.YesNo, Title:="Blinks Digital Diary")
            If a = MsgBoxResult.Yes Then
                udechukwu.ExecuteNonQuery()
                reinsert.ExecuteNonQuery()
                Dim aa As Integer = MsgBox("Your biodata has been deleted.", MsgBoxStyle.OkOnly, Title:="Blinks Digital Diary")
                Me.Close()
            Else
                Me.Show()
            End If
        ElseIf frmmyprofile.TextBox1.Text = "Modify" Then
            ...
            Me.Close()
            frmmyprofile.Close()
            Dim a As Integer = MsgBox("Your biodata has been modified", MsgBoxStyle.OkOnly, Title:="Blinks Digital Diary")
        Else
            Me.Close()
            frmmyprofile.Close()
        End If

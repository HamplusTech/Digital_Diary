...
Public Class LoginForm1
    ...
    Private Sub OK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK.Click
        If UsernameTextBox.Text = "hamplus" And PasswordTextBox.Text = "digitalboy" Then
            Main.Show()
            Me.Hide()
        Else
            ...
            If rd.HasRows = True Then
                ...
                Me.Hide()
            Else
                MsgBox("Username and Password are Invalid", MsgBoxStyle.OkOnly, Title:="Blinks Digital Diary")
            End If
        End If
    End Sub

    Private Sub Cancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cancel.Click
        Dim a As Integer = MsgBox("Do You Desire to Close Application?", MsgBoxStyle.YesNo, Title:="Blinks Digital Diary")
    ...
    Private Sub LinkLabel2_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles LinkLabel2.LinkClicked
        ...
        Dim a = MsgBox("Are You Sure of the Diary ID?", MsgBoxStyle.YesNo, Title:="Blinks Digital Diary")
        If a = MsgBoxResult.Yes Then
            Dim uju, jp As New DBops
            uju.DiaryConnect()
            jp.DiaryDT()
            ...
            Else
                Dim aa = MsgBox("Wrong Diary ID", MsgBoxStyle.OkOnly, Title:="Blinks Digital Diary")
                InputBox("Please Enter Your Diary ID", "Blinks Digital Diary", "Diary ID")
            End If
        Else
            InputBox("Please Enter Your Diary ID. Please check and retype your Diary ID", "Blinks Digital Diary", "Diary ID")
        End If
    End Sub

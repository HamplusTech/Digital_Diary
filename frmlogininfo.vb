...
Public Class frmlogininfo
    ...
    Private Sub frmlogininfo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            ElseIf frmmyprofile.TextBox1.Text = "Delete" Then
                Dim a As Integer = MsgBox("You can not delete your login info", MsgBoxStyle.OkOnly, Title:="Blinks Digital Diary")
    ...
    Private Sub btnok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnok.Click
       If frmmyprofile.TextBox1.Text = "Modify" Then
            ...
            Me.Close()
            frmmyprofile.Close()
            Dim a As Integer = MsgBox("Your login info has been modified", MsgBoxStyle.OkOnly, Title:="Blinks Digital Diary")
        Else
            Me.Close()
            frmmyprofile.Close()
        End If
